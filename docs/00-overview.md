...
- Watchdog: five 1-byte alive toggles in config_shm at 10284 ble / 10288 media / 10296 ctrl / 10300 agora / 10304 cloud, each written ~every 2 s; stale -> restart -> kill -> `reboot -f`. Replacement agent must toggle 10296/10300/10304 (or run without ctrl/agora/cloud by taking over watchdog). Threshold N still unread.
